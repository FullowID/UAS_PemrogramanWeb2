...
<div class="text-secondary px-5 text-center">
    <div class="py-1">
        <h2 class="display-5 fw-bold text-white">Edit Class</h2>
    </div>
</div>
                ...
                <div class="card-body">
                    <div class="mb-3 col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="classname" id="classname" value="{{$operator_class->classname}}" class="form-control" placeholder="Classname">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="position" id="position" value="{{$operator_class->position}}" class="form-control" placeholder="Position">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description" placeholder="Class Description" rows="4">{{ $operator_class->description }}</textarea>
                        </div>
                    </div>
