...
<div class="container m-4">
    <div class="row justify-content-start">
        ...
        <div class="col text-center">
            <h2 class="text-white">Operator Class</h2>
        </div>
    </div>
</div>
<div class="container mb-3">
    <div class="row justify-content-end">
        <div class="col-2">
            <a class="btn rounded-pill shadow btn-success" href="{{ route('operator_class.create') }}">Create New Class</a>
        </div>
    </div>
</div>
        ...
        <td>
            <div class="container">
                <div class="col">
                    ...
                    <a class="btn my-2 py-2  btn-info" href="{{ route('operator_class.show',$item->id) }}">Show</a>
                    <a class="btn my-2 py-2  btn-primary" href="{{ route('operator_class.edit',$item->id) }}">Edit</a>
