...
<table class="table text-center table-striped table-dark table-hover text-white">
    ...
    <tr>
        ...
        <td>
            <div class="container">
                <div class="row justify-content-end row-cols-lg-5 g-2 g-lg-1">

                    <a class="btn mx-2 col btn-info" href="{{ route('faction.show',$item->id) }}">Show</a>
                    <a class="btn mx-2 col btn-primary" href="{{ route('faction.edit',$item->id) }}">Edit</a>
